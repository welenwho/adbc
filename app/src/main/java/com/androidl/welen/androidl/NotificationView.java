...
public abstract class NotificationView extends FrameLayout {
    ...
    public NotificationView(Context context, AttributeSet attrs) {
        super(context, attrs);
        mMaxNotificationHeight = DimenUtils.dp2px(context, 256);
    }
     ...
     * drawing rect, since we layout all children in the {@link NotificationScrollLayout} at
    ...
    public interface OnHeightChangedListener {
         ...
         */
        void onHeightChanged(NotificationView view);
         ...
         */
        void onReset(NotificationView view);
    }
}
